...
import 'package:shopping/view/_product/_widgets/card/region_food.dart';
import 'package:shopping/view/_product/_widgets/card/Popular_restaurent_card.dart';
import 'package:shopping/view/_product/_widgets/card/most_popular.dart';
import 'package:shopping/view/_product/_widgets/listtile/recent_item.dart';
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Row(
            children: [
              Text(
                "${LocaleKeys.goodMorning.tr()} $userName!",
